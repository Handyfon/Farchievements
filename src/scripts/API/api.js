...
const API = {
  resetSettings: async function () {
    ...
    await game.settings.set(CONSTANTS.MODULE_ID, SETTINGS.clientdataSYNC, "");
    await game.settings.set(CONSTANTS.MODULE_ID, SETTINGS.clientdata, "");
  },
